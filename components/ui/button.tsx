...
const buttonVariants = cva(
  " inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm  ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-black font-light text-primary-foreground hover:bg-black/50",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border text-white/80 font-light  bg-transparent hover:bg-accent hover:text-accent-foreground border border-gray-400",
        secondary:
          "bg-black text-white hover:bg-black/80 border-white/50  border",
